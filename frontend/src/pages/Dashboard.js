...
function Dashboard() {
  ...
  const topCustomers = Object.keys(ordersByCustomer).sort((a,b)=>ordersByCustomer[b]-ordersByCustomer[a]).slice(0,5);
  const ordersBarData = {
    labels: topCustomers,
    datasets: [{
  ...
  return (
    <Container sx={{ mt:4, pb:4 }}>
      ...
      <Typography variant="h4" mt={6} mb={2} sx={{ fontWeight:600 }}>Charts & Insights</Typography>

      <Grid container spacing={4} mt={2}>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p:2, ...chartCardHeight }}>
            <Typography variant="h6" sx={{ fontWeight:600, mb:2 }}>Top 5 Budgets by Limit (Bar)</Typography>
            <Box sx={{flexGrow:1}}>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p:2, ...chartCardHeight }}>
            <Typography variant="h6" sx={{ fontWeight:600, mb:2 }}>Expense Distribution by Budget (Pie)</Typography>
            <Box sx={{flexGrow:1}}>
      ...
      <Grid container spacing={4} mt={2}>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p:2, ...chartCardHeight }}>
            <Typography variant="h6" sx={{ fontWeight:600, mb:2 }}>Top Customers by Total Order Amount (Bar)</Typography>
            <Box sx={{flexGrow:1}}>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p:2, ...chartCardHeight }}>
            <Typography variant="h6" sx={{ fontWeight:600, mb:2 }}>Orders by Status (Doughnut)</Typography>
            <Box sx={{flexGrow:1}}>
      ...
      <Grid container spacing={4} mt={2}>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p:2, ...chartCardHeight }}>
            <Typography variant="h6" sx={{ fontWeight:600, mb:2 }}>Monthly Expenses (Radar)</Typography>
            <Box sx={{flexGrow:1}}>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p:2, ...chartCardHeight }}>
            <Typography variant="h6" sx={{ fontWeight:600, mb:2 }}>Tasks by Status (Polar Area)</Typography>
            <Box sx={{flexGrow:1}}>
      ...
      <Grid container spacing={4} mt={2}>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p:2, ...chartCardHeight }}>
            <Typography variant="h6" sx={{ fontWeight:600, mb:2 }}>Avg Expense/User vs Total Budget Limit (Horizontal Bar)</Typography>
            <Box sx={{flexGrow:1}}>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p:2, ...chartCardHeight }}>
            <Typography variant="h6" sx={{ fontWeight:600, mb:2 }}>Transaction Amount Distribution by Budget (Doughnut)</Typography>
            <Box sx={{flexGrow:1}}>
      ...
      <Grid container spacing={4} mt={2}>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p:2, ...chartCardHeight }}>
            <Typography variant="h6" sx={{ fontWeight:600, mb:2 }}>Overall Entities Count (Bar)</Typography>
            <Box sx={{flexGrow:1}}>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p:2, ...chartCardHeight }}>
            <Typography variant="h6" sx={{ fontWeight:600, mb:2 }}>Completed vs Pending Tasks Ratio (Doughnut)</Typography>
            <Box sx={{flexGrow:1}}>
      ...
      <Grid container spacing={4} mt={2}>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p:2, ...chartCardHeight }}>
            <Typography variant="h6" sx={{ fontWeight:600, mb:2 }}>Scatter: Expenses vs Days (Mock)</Typography>
            <Box sx={{flexGrow:1}}>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p:2, ...chartCardHeight }}>
            <Typography variant="h6" sx={{ fontWeight:600, mb:2 }}>Bubble: User Activity (Mock)</Typography>
            <Box sx={{flexGrow:1}}>
      ...
      <Typography variant="h4" mt={5} mb={5} sx={{ fontWeight:600 }}>Quick Links</Typography>
            ...
            <Card sx={{...linkCardHeight}}>
              <CardContent sx={{ textAlign:'center' }}>
                <Typography variant="h6" sx={{ fontWeight:600 }}>
                  <Link to={l.to} style={{textDecoration:'none',color:'inherit'}}>{l.label}</Link>
                </Typography>
              </CardContent>
            </Card>
          </Grid>
